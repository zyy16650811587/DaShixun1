...
public class HttpManager {
    ...
    public static HttpManager getInstance() {
        ...
        private Retrofit getrerofit(String url, long outTime, TimeUnit timeUnit){
    ...
    private OkHttpClient getBaseOkhttp(long outTime, TimeUnit timeUnit) {
...
//        };
    ...
    private OkHttpClient getCliect(long outTime, TimeUnit timeUnit, Interceptor ...interceptors) {
